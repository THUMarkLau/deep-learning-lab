...
def load_data(data_dir = "../data/",input_size = 224,batch_size = 36, topic="1-Large-Scale"):
    data_transforms = {
    ...
    image_dataset_train = datasets.ImageFolder(os.path.join(data_dir, topic, 'train'), data_transforms['train'])
